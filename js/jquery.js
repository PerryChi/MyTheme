!function (b) {
    ...
    d.prototype = {
        ...
        return this.each(function () {
            var g = e(this), c = g.data("modal"), b = e.extend({},
        ...
        function (a) {
            var j = e(this), i = j.attr("href"), h = e(j
                    .attr("data-target")
                || i && i.replace(/.*(?=#[^\s]+$)/, "")), g = h
    ...
    l.prototype = {
        ...
        "click.dropdown.data-api", ".dropdown form", function (b) {
            b.stopPropagation()
    ...
    d.prototype = {
        constructor: d,
        show: function () {
            var j, i, h, a = this.element, l = a
                .closest("ul:not(.dropdown-menu)"), k = a
                .attr("data-target");
        ...
        activate: function (a, l, k) {
            ...
            var j = l.find("> .active"), i = k && e.support.transition
                && j.hasClass("fade");
        ...
        '[data-toggle="tab"], [data-toggle="pill"]', function (a) {
    ...
    d.prototype = {
        ...
        return this.each(function () {
            var g = e(this), c = g.data("tooltip"), b = "object" == typeof a
                && a;
    ...
    d.prototype = e.extend({}, e.fn.tooltip.Constructor.prototype, {
        ...
        return this.each(function () {
            var g = e(this), c = g.data("popover"), b = "object" == typeof a
                && a;
...
(function (a) {
    Date.now = Date.now || function () {
        ...
        var G = a.extend({}, a.ias.defaults, A), C = new a.ias.util, J = new a.ias.paging(G.scrollContainer), B = G.history
            ? new a.ias.history
            : !1, F = this;
        x()
    }, a.ias.defaults = {
...
!function () {
    var e = jQuery.event.special, d = "D" + +new Date, f = "D"
        + (+new Date + 1);
    e.scrollstart = {
        setup: function () {
            var b, a = function (c) {
    ...
    a(document).ready(function () {
        ...
        a.fn.postLike = function () {
            if (a(this).hasClass("actived")) {
                ...
                var z = a(this).data("id"), y = a(this).data("action"), x = a(this)
                    .children(".count");
                var w = {
                    action: "bigfa_like",
                    um_id: z,
        ...
        a("#commentform").submit(function () {
            ...
            a.ajax({
                ...
                success: function (B) {
                    ...
                    var y = addComment, A = y.I("cancel-comment-reply-link"), w = y
                        .I("wp-temp-form-div"), C = y.I(y.respondId), x = y
                        .I("comment_post_ID").value, z = y
                        .I("comment_parent").value;
        ...
        addComment = {
            moveForm: function (z, A, E, y, B) {
                var I = this, w, D = I.I(z), x = I.I(E), H = I
                    .I("cancel-comment-reply-link"), F = I
                    .I("comment_parent"), G = I.I("comment_post_ID");
                if (o) {
                    p()
                }
                B
                ...
                H.onclick = function () {
                    ...
                    var K = addComment, J = K.I("wp-temp-form-div"), L = K
                        .I(K.respondId);
